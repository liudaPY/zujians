...
- (void)layoutSubviews {
    ...
    CGRect rect = [label.text boundingRectWithSize:CGSizeMake(maxWidth, 0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16.f]} context:nil];
...
//            hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"CWResource.bundle/CheckmarkOk"]];
            hud.customView = [[UIImageView alloc] initWithImage:[NSBundle cw_imageWithNamed:@"CheckmarkOk"]];
        }else{
//            hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"CWResource.bundle/Crossmark"]];
            hud.customView = [[UIImageView alloc] initWithImage:[NSBundle cw_imageWithNamed:@"Crossmark"]];
        }
    }
